...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'View_UserDocs_AllUserCreatedDocs';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'50
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'View_UserDocs_AllUserCreatedDocs';
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      ...
      Begin ColumnWidths = 11
         ...
         SortOrder = 1410
         GroupBy = 1350
         Filter = 13', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'View_UserDocs_AllUserCreatedDocs';
